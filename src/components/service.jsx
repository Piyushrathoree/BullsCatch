        ...
        <div className="w-[25rem] text-white space-y-8 flex flex-col gap-8 justify-center">
          <div className="flex flex-col gap-3">
            <h3 className="text-2xl text-white">
              <span className="font-thin text-lg">✨</span> Understanding
            </h3>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-2xl text-white">
              <span className="font-thin text-lg">✨</span> Sourcing
            </h3>
            <p className="text-gray-400 w-[22rem]">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-2xl text-white">
              <span className="font-thin text-lg">✨</span> Calibration
            </h3>
            <p className="text-gray-400 w-[22rem]">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-2xl text-white">
              <span className="font-thin text-lg">✨</span> Engagement
            </h3>
            <p className="text-gray-400 w-[22rem]">
