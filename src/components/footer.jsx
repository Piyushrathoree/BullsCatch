...
const Footer = () => {
  return (
    <div className='w-[100vw] absolute left-[6vw]'>
    <section class="relative py-24 bg-black overflow-hidden">
  <img className="absolute bottom-0 left-0" src="gradia-assets/elements/footers/radial2.svg" alt="" />
    ...
    <div class="flex flex-wrap -m-6">
      ...
      <div class="w-full md:w-1/2 lg:w-2/12 p-6">
        <div class="h-full">
          ...
          <ul>
            <li class="mb-4"><a class="font-heading font-medium text-base text-white hover:text-gray-200" href="#">About us</a></li>
            <li class="mb-4"><a class="font-heading font-medium text-base text-white hover:text-gray-200" href="#">Career</a></li>
